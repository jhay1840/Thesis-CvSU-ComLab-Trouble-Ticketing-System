...
Public Class Form4
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If counter = 0 Then
            ...
            Label4.Text = "Total tasks this year:"
            Label5.Text = "Total tasks completed:"
            Label6.Text = "Pending Tickets this year: "
        Else
            perc = 100 / (counter / cmp)
            BunifuCircleProgressbar1.Value = perc
            Label4.Text = "Total tasks this year: " & counter & ""
            Label5.Text = "Total tasks completed: " & cmp & ""
            Label6.Text = "Pending Tickets this year: " & pend & ""
    ...
    Private Sub btn_export_Click(sender As Object, e As EventArgs) Handles btn_export.Click
        ...
        Try
            ...
            SaveFileDialog1.FileName = "Annual Report " & Now.Day & "-" & Now.Month & "-" & Now.Year & ".xlsx"
